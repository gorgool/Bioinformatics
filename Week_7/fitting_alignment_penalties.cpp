...
#include <tuple>
#include <algorithm>
#include "graph_fitting_penalties.h"
...
tuple<int, string, string> fitting_alignment_penalties(const string& s1, const string& s2)
{
  L3_fitting_penalty_graph g;
